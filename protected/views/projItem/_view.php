...
<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->proj_item_id), array('view', 'id'=>$data->proj_item_id)); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('proj_category_id')); ?>:</b>
	<?php echo CHtml::encode($data->proj_category_id); ?>
	<br />
